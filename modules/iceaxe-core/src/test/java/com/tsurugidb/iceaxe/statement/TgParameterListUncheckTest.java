...
class TgParameterListUncheckTest {
    ...
    private void assertParameterList(TgParameter expected, TgParameterListUncheck actual) {
        assertParameterList(List.of(expected), actual);
    }

    private void assertParameterList(TgParameter expected1, TgParameter expected2, TgParameterListUncheck actual) {
        assertParameterList(List.of(expected1, expected2), actual);
    }

    private void assertParameterList(List<TgParameter> expected, TgParameterListUncheck actual) {
    ...
    void testToString() {
        ...
        assertEquals("TgParameterListUncheck[]", empty.toString());
    }
}
